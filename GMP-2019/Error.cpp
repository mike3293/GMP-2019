...
namespace Error
{
	...
	*/
	ERROR errors[ERROR_MAX_ENTRY] =  //òàáëèöà îøèáîê
	{
		...
		ERROR_ENTRY(502,"SEM: Âîçâğàùàåìîå çíà÷åíèå íå ñîîòâåòñâóåò òèïó ôóíêöèè"), 
		ERROR_ENTRY(503,"SEM: Êîëè÷åñòâî ïàğàìåòğîâ ôóíêöèè áîëüøå äîïóñòèìîãî"), 
		ERROR_ENTRY(504,"SEM: Ïåğåäàâàåìûå ïàğàìåòğû íå ñîîòâåòñâóşò ôóíêöèè"),
		ERROR_ENTRY(505,"SEM: Íå ñîîòâåòñâóåò êîëè÷åñòâî ïåğåäàâàåìûõ ïàğàìåòğîâ"), 
		ERROR_ENTRY(506,"SEM: Îøèáêà â ïàğàìåòğàõ ôóíêöèè raiseto()"), 
