...
namespace Error
{
	...
	*/
	ERROR errors[ERROR_MAX_ENTRY] =  //òàáëèöà îøèáîê
	{
		...
		ERROR_ENTRY(500,"SYN: Íåò òî÷êè âõîäà main"), 
		ERROR_ENTRY(501,"SYN: Áîëåå îäíîé òî÷êè âõîäà main"), 
		ERROR_ENTRY(502,"SYN: Âîçâğàùàåìîå çíà÷åíèå íå ñîîòâåòñâóåò òèïó ôóíêöèè"), 
		ERROR_ENTRY(503,"SYN: Êîëè÷åñòâî ïàğàìåòğîâ ôóíêöèè áîëüøå äîïóñòèìîãî"), 
		ERROR_ENTRY(504,"SYN: Ïåğåäàâàåìûå ïàğàìåòğû íå ñîîòâåòñâóşò ôóíêöèè"),
		ERROR_ENTRY(505,"SYN: Íå ñîîòâåòñâóåò êîëè÷åñòâî ïåğåäàâàåìûõ ïàğàìåòğîâ"), 
		ERROR_ENTRY(506,"SYN: Îøèáêà â ïàğàìåòğàõ ôóíêöèè raiseto()"), 
		ERROR_ENTRY(507,"SYN: Îøèáêà â ïàğàìåòğàõ ôóíêöèè compare()"), 
		ERROR_ENTRY(508,"SYN: Ïîïûòêà ñğàâíåíèÿ îïåğàíäîâ íå òèïà ushort"), 
		ERROR_ENTRY(509,"SYN: Îøèáêà â ïàğàìåòğå ôóíêöèè print()"), 
		ERROR_ENTRY_NODEF10(510), ERROR_ENTRY_NODEF10(520),
		ERROR_ENTRY_NODEF10(530), ERROR_ENTRY_NODEF10(540), ERROR_ENTRY_NODEF50(550),
		ERROR_ENTRY(600,"SEM: Íåâåğíàÿ ñòğóêòóğà ïğîãğàììû"),
		ERROR_ENTRY(601,"SEM: Îøèáî÷íàÿ êîíñòğóêöèÿ â ôóíêöèè"),
		ERROR_ENTRY(602,"SEM: Îøèáêà â âûğàæåíèè"),
		ERROR_ENTRY(603,"SEM: Îøèáêà â ïàğàìåòğàõ ôóíêöèè"),
		ERROR_ENTRY(604,"SEM: Îøèáêà â ïàğàìåòğàõ âûçûâàåìîé ôóíêöèè"),
		ERROR_ENTRY(605,"SEM: Îøèáî÷íûé îïåğàòîğ"),
